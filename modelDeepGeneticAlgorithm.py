...
class BSDESolver(object):
    ...
    def train(self, num_iterations):
        # training num_iterations times
        for i in range(num_iterations):
            self.train_step(self.bsde.sample(self.net_config.batch_size))
    
    def get_valid_data(self):
        return self.bsde.sample(self.net_config.valid_size)

    def loss_ga(self, valid_data):
    ...
    def set_y_init(self, y_init):
        self.model.y_init.assign(y_init)
